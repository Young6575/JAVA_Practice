...
public class 실습_5_1_클래스자동차정의 {
	 ...
	 * 
	 * // 전장 기준으로 차급 세그먼트 분류 String getSegment() { if (length < 4200) { return
	 * "B-세그먼트 (소형차)"; //.... } // 과속 여부 판단 메소드 void checkSpeeding(int speedLimit) {
	 * if (speed > speedLimit) { System.out.println("과속 경고!"); } else {
